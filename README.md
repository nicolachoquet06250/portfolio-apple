 ...
 - [<span style="color: red">&cross;</span>] Applications à développer :
   ...
   - [<span style="color: gray"> ? </span>] Finder
     - [<span style="color: gray"> ? </span>] Système d'arboraissence virtuelle pour pouvoir stocker des fichier sous forme base64 dans la base de données localDB du navigateur de sorte que les données des utilisateurs ne sortent pas de l'application
       ...
       - [<span style="color: green">&check;</span>] Création de fichiers texte brute
       - [<span style="color: red">&cross;</span>] Modification des fichiers texte brute
...
- [Process d'installation IOS sur le **site d'Apple**](https://support.apple.com/en-us/HT202033)
...
- [Darwin open source version](https://www.puredarwin.org/)
- [PWABuilder](https://www.pwabuilder.com/reportcard?site=https://www.nicolaschoquet.fr)
- Screenshots
  - [Requête n°1 notif avec boutons](https://www.google.com/search?sca_esv=587309246&sxsrf=AM9HkKnWKfELL_m9cJMj6uWqHxb87i4rCw:1701534448557&q=screenshot+de+notifications+avec+boutons+sur+%C3%A9cran+de+verrouillage+ios&tbm=isch&source=lnms&sa=X&ved=2ahUKEwiMkoTjlfGCAxURVqQEHfSADYMQ0pQJegQIDRAB&biw=1096&bih=529&dpr=4#imgrc=E5cknxWpNooVKM)
    - https://drfone.wondershare.fr/unlock/iphone-lock-screen-with-notifications.html
    - https://support.apple.com/fr-ml/HT201925
  - [Requête n°2 notif avec boutons](https://www.google.com/search?q=notification+avec+boutons+sur+sur+%C3%A9cran+de+v%C3%A9rouillage+ios&tbm=isch&ved=2ahUKEwiJsqGtmfGCAxVumycCHRjxCSEQ2-cCegQIABAA&oq=notification+avec+boutons+sur+sur+%C3%A9cran+de+v%C3%A9rouillage+ios&gs_lcp=CgNpbWcQAzoECCMQJ1CLDVjhswFg2rgBaAJwAHgAgAFhiAGsCpIBAjE1mAEAoAEBqgELZ3dzLXdpei1pbWfAAQE&sclient=img&ei=sV5rZcmVIO62nsEPmOKniAI&bih=529&biw=1096#imgrc=voREavIjYA9pwM)
    - https://support.apple.com/fr-fr/102388