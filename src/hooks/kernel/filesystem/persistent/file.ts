import type {FileItem, UseFileSystemReturn} from '../types.ts';
import {fsTree} from '../index.ts';
import {create as createDirectory} from './directory.ts';
import {directoryExists, fileExists} from '@/hooks/kernel/filesystem/functions.ts';
