<template>
  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 120 120" :width="width" :height="height" id="mail">
    <defs>
      <linearGradient id="mailsColor" x1="26.206" x2="146.207" y1="-1059.782" y2="-1059.782"
                      gradientTransform="rotate(90 -486.788 -512.994)" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#1d6ff2"></stop>
        <stop offset="1" stop-color="#1ac8fc"></stop>
      </linearGradient>
    </defs>
    <path fill="url(#mailsColor)" fill-rule="evenodd"
