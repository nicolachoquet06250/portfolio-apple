<template>
  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 120 120" :width="width" :height="height" id="app-store">
    <defs>
      <linearGradient id="storeGradient" x1="-1315.782" x2="-1195.782" y1="529.793" y2="529.793"
                      gradientTransform="rotate(-90 -832.788 -362.994)" gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#1d6ff2"></stop>
        <stop offset="1" stop-color="#1ac8fc"></stop>
      </linearGradient>
    </defs>
    <path fill="url(#storeGradient)" fill-rule="evenodd"
          d="M120,26V94a25.94821,25.94821,0,0,1-26,26H26A25.94821,25.94821,0,0,1,0,94V26A25.94821,25.94821,0,0,1,26,0H94A25.94821,25.94821,0,0,1,120,26Z"></path>
