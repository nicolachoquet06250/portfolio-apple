<template>
  <svg xmlns="http://www.w3.org/2000/svg" data-name="Layer 1" viewBox="0 0 120 120" :width="width" :height="height" id="camera">
    <defs>
      <linearGradient id="cameraColor" x1="60" x2="60" y1="16" y2="-104" gradientTransform="translate(0 104)"
                      gradientUnits="userSpaceOnUse">
        <stop offset="0" stop-color="#8e8e93"></stop>
        <stop offset="1" stop-color="#e5e5ea"></stop>
      </linearGradient>
    </defs>
    <path fill="url(#cameraColor)"
          d="M26,0H94a25.94821,25.94821,0,0,1,26,26V94a25.94821,25.94821,0,0,1-26,26H26A25.94821,25.94821,0,0,1,0,94V26A25.94819,25.94819,0,0,1,26,0Z"></path>
    <path fill="#2e2e2f" fill-rule="evenodd"
